...
object saurav_sahu_task1 {
  ...
  * */
  ...
  def handleFinalOutput(filename:String,predictions: collection.Map[(Int, Int), Double],testingGroundDataKV: collection.Map[(Int, Int), Double]) = {
...
//    val defaultRating = 3.0
    ...
    math.sqrt(sumOfSquaresOfErrors/numElements)
  }
}
